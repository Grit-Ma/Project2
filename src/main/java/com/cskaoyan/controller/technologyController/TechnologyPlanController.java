...
public class TechnologyPlanController {
    ...
    @ResponseBody
    public ResponseVo insertTechnologyPlan(Technology_plan technologyPlan){
    ...
    @ResponseBody
    public ResponseVo updateTechnologyPlan(Technology_plan technologyPlan){
        ResponseVo responseVo = new ResponseVo();
    ...
    @ResponseBody
    public List<Technology_plan> technologyPlanGetData(){
        List<Technology_plan> list = planService.queryAllTechnologyPlan();
        return list;
    }
    ...
    @ResponseBody
    public Technology_plan getTechnologyPlanById(@PathVariable("technologyPlanId") String technologyPlanId){
        Technology_plan technologyPlan = planService.queryTechnologyPlanById(technologyPlanId);
    ...
    public HashMap<String,Object> searchByTechnologyPlanId(String searchValue,int page,int rows){
        HashMap<String, Object> map = new HashMap<>();
        String flag = "planId";
        List<Technology_plan> list = planService.searchByTechnologyPlanId(searchValue ,page,rows,flag);
    ...
    public HashMap<String,Object> search_technologyPlan_by_technologyName(String searchValue,int page,int rows){
        ...
        List<Technology_plan> list = planService.searchByTechnologyPlanIdOrName(searchValue,page,rows,flag);
