...
public class TechnologyRequirementController {
    ...
    public HashMap<String,Object> technologyRequirementManage(int page, int rows){
        List<TechnologyRequirement> list = requirementService.queyTechnologyRequirement(page,rows);
    ...
    @ResponseBody
    public ResponseVo insertTechnologyRequirement(TechnologyRequirement requirement){
    ...
    @ResponseBody
    public ResponseVo updateTechnologyRequirement(TechnologyRequirement technologyRequirement){
        ResponseVo responseVo = new ResponseVo();
    ...
    public HashMap<String,Object> searchByTechnologyRequirementId(int searchValue,int page,int rows){
        ...
        List<TechnologyRequirement> list = requirementService.searchByTechnologyRequirementId(searchValue + "",page,rows,flag);
    ...
    public HashMap<String,Object> search_technology_by_technologyName(String searchValue,int page,int rows){
        ...
        List<TechnologyRequirement> list = requirementService.searchByTechnologyIdOrName(searchValue,page,rows,flag);
