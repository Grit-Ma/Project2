...
public class ProcessCountCheck {
    ...
    public ProcessCountCheck(String pCountCheckId, String processId, String checkItem, Integer sample, Integer checkNumber, Integer unqualify, BigDecimal qualify, Date cdate, String measureData, String empId, String result, String note, String empName) {
