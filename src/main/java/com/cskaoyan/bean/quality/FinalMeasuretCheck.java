...
public class FinalMeasuretCheck {
    ...
    public FinalMeasuretCheck(String fMeasureCheckId, String orderId, String checkItem, Date cdate, String measureData, String empId, String result, String note, String empName) {
